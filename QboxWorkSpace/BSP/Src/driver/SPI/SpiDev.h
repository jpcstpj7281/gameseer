...
#define AT45_SPI_CLK    (3000000)                         /*SPI时钟频率*/
...
extern DWORD SpiWrite(BYTE byPort, BYTE byAddr, BYTE byData);
extern DWORD SpiRead(BYTE byPort, BYTE byAddr, BYTE *pbyData);
