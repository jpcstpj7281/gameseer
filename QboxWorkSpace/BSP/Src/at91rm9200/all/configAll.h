...
--------------------
08w,28oct05,h_k  increased STACK_SAVE for SH. (SPR #112259)
08y,28jan04,tra  changes done for incorporation of NFS v2/v3 code into RS 1.3 
08x,18sep03,wap  Move END_POLL_STATS_ROUTINE_HOOK to usrNetwork.c
08w,31jul03,rae  merged from CP1 (SPR 74633)
08v,18feb03,wap  Provide default definition for END_POLL_STATS_ROUTINE_HOOK
...
#if (defined (INCLUDE_NFS2_SERVER) || defined (INCLUDE_NFS3_SERVER) \
    || defined (INCLUDE_NFS_SERVER_ALL) || defined (INCLUDE_NFS2_CLIENT) \
    || defined (INCLUDE_NFS3_CLIENT) || defined (INCLUDE_NFS_CLIENT_ALL))
