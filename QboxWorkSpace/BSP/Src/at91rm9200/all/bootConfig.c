...
--------------------
12z,05jul05,spw  SPR 99783.  Fix TCP_CFG_PARAMS structure.  Fix copyright
12y,04nov03,rae  merged from wrn_wipro_fix_bg branch (SPR #88988)
12x,14apr04,pch  SPR 95355: enable interrupts in root task after MMU is set up.
		 Fix warnings re constant conditionals involving NUM_TTY.
12w,20jun03,t_m  add INCLUDE_PCCARD
...
TCP_CFG_PARAMS tcpCfgParams =   /* tcp configuration parameters */
    ...
    /*TCP_REASS_GLOBAL_MAX_CFG,    max segments in reassembly queues */
    /*TCP_REASS_ENDPT_MAX_CFG      max segments in one reass. queue, or -1 */
    };
#endif /* INCLUDE_TCP */
