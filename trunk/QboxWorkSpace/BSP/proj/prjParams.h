...
#undef INCLUDE_MMC
#undef INCLUDE_SPI_DATAFLASH_CARD
#undef INCLUDE_DISPLAY
#undef INCLUDE_USB_SLAVE_BULK
#undef INCLUDE_SOUND_CODEC


/*** PARAMETERS ***/

#undef  LOCAL_MEM_LOCAL_ADRS
#define LOCAL_MEM_LOCAL_ADRS 0x20000000
#undef  LOCAL_MEM_SIZE
#define LOCAL_MEM_SIZE 0x03800000
...
#define DEFAULT_BOOT_LINE "eth(0,0) host:vxWorks " "h=192.168.0.101 e=192.168.0.102:ffffff00 u=target pw=target"
#undef  RESERVED
#define RESERVED 0
#undef  FREE_RAM_ADRS
...
#undef  RAM_HIGH_ADRS
#define RAM_HIGH_ADRS 0x21000000
#undef  RAM_LOW_ADRS
...
#define LOGIN_USER_NAME "vtron"
#undef  LOGIN_PASSWORD
#define LOGIN_PASSWORD "bSz9SeRbyz"
#undef  NUM_NET_MBLKS
