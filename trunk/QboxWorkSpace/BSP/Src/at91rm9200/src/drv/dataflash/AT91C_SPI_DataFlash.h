...
}AT91S_DataFlash_Device, *AT91PS_DataFlash_Device;

/* Global Variables*/
extern AT91S_DataflashFeatures		DeviceAT45DB;
extern AT91S_DataflashFeatures		DeviceAT45DCB;

#define DATAFLASH_TCSS		(0xf << 16)	/* 250ns 12/48000000 */
#define DATAFLASH_TCHS		(0x1 << 24)	/* 250ns 32*1/48000000 */
