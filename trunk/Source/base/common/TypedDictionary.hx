...
//#if flash
//typedef  TypedDictionary = flash.utils.TypedDictionary< Void->Dynamic, Bool >;
//#else
//
//typedef  TypedDictionary = ObjectHash < Void->Dynamic, Bool > ;
...
class TypedDictionary<Key, Val> 
{
	...
	public function iterator():Iterator<Val>
	{
#if flash9
