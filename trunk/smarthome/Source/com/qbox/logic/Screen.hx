...
class Screen extends Qbox{
    ...
    public function setWnd(x:Int, y:Int, w:Int, h:Int, cbSetWndFunc:Dynamic->Screen->Void ){
        ...
        if (isOutOfScreen){
            ...
            addKeyVal( "out", Bytes.ofString("default"));
            sendData();
#else
    ...
    public function setChannel( winHandle:String,  input:String, cbSetChannelFunc:Dynamic->Screen->Void, wnd:Wnd):Void{
        ...
        if ( p != null){ 
            ...
            if ( p != null){
                ...
                trace( "there is not ports available to set channel!");
                return;
            }
        }
        ...
        q.addKeyVal( "in", Bytes.ofString(input));
        q.sendData();
        //}
        //break;
        //}
    ...
    public function closeWnd( winHandle:String, cbCloseWndFunc:Dynamic->Screen->Void ):Bool{
