...
{
    /*Disable TOD*/
	I2C_Write(byChannels, I2C_ADDR_USER_MAP, AD9388_USER_TOD, 0x0c);
    /*28.63636MHz LLC Pin Active*/
	I2C_Write(byChannels, I2C_ADDR_USER_MAP,AD9388_USER_VER_SCAL_VAL, 0x40);
     /*PCLK polarity*/
	I2C_Write(byChannels, I2C_ADDR_USER_MAP,AD9388_USER_TLLC_POLARITY, 0x01);
     /*SOG Sync level for atenuated sync, PLL Qpump = 6h*/
	I2C_Write(byChannels, I2C_ADDR_USER_MAP,AD9388_USER_TLLC_CTRL, 0xae);
     /*Enable Automatic PLL_Qpump and VCO Range*/
	I2C_Write(byChannels, I2C_ADDR_USER_MAP,AD9388_USER_PLL_QPUMP_CTRL, 0x0a);
     /*Auto CSC , RGB Out*/
	I2C_Write(byChannels, I2C_ADDR_USER_MAP,AD9388_USER_CSC_23, 0xf2);
     /*TURN OFF EAV & SAV CODES*/
	I2C_Write(byChannels, I2C_ADDR_USER_MAP,AD9388_USER_CP_AV_CTRL, 0x1d);
     /*Progressive mode*/
	I2C_Write(byChannels, I2C_ADDR_USER_MAP, AD9388_USER_DPP_CP_64, 0x10);
     /*Enable HDMI and Analog in*/
	I2C_Write(byChannels, I2C_ADDR_USER_MAP,AD9388_USER_HDMI_CTRL, 0xa0);
     /*Max Drive Strength*/
	I2C_Write(byChannels, I2C_ADDR_USER_MAP,AD9388_USER_DRIVE_STR, 0x3f);

	I2C_Write(byChannels, I2C_ADDR_USER_MAP, AD9388_USER_ADC_CTRL, 0x60);
...
void DriverChip9388A::dev_DetectCPRun(uint32_t byChannels,uint8_t &byInputState)
{
    ...
    I2C_Read(byChannels,I2C_ADDR_USER_MAP,AD9388_USER_STATUS_2,byRtn);
...
void DriverChip9388A::getBL(uint32_t byChannel,uint16_t &wBLValue)
{
    ...
    I2C_Read(byChannel,I2C_ADDR_USER_MAP,AD9388_USER_RB_STD_ID_1,byValue);
    wBLValue = byValue & 0x3f;
    wBLValue = wBLValue << 8;


    I2C_Read(byChannel,I2C_ADDR_USER_MAP,AD9388_USER_RB_STD_ID_2,byValue);
...
void DriverChip9388A::getFL(uint32_t byChannel,uint16_t &wFLValue)
{
    ...
    I2C_Read(byChannel,I2C_ADDR_USER_MAP,AD9388_USER_FCL_1,byValue);
    wFLValue = byValue & 0x1f;
    wFLValue = wFLValue << 8;


    I2C_Read(byChannel,I2C_ADDR_USER_MAP,AD9388_USER_FCL_2,byValue);
...
void DriverChip9388A::getSCF(uint32_t byChannel,uint16_t &wSCFValue)
{
    ...
    I2C_Read(byChannel,I2C_ADDR_USER_MAP,AD9388_USER_RB_STD_ID_3,byValue);
    wSCFValue = byValue & 0x07;
    wSCFValue = wSCFValue << 8;


    I2C_Read(byChannel,I2C_ADDR_USER_MAP,AD9388_USER_RB_STD_ID_4,byValue);
...
void DriverChip9388A::getHsPol(uint32_t byChannel,uint8_t &byPolarity)
{
    ...
    I2C_Read(byChannel,I2C_ADDR_USER_MAP,AD9388_USER_RB_STD_ID_5,byValue);
...
void DriverChip9388A::dev_DRGB_GeneralConfig(uint32_t byChannel)
{
	...
	I2C_Write(byChannel, I2C_ADDR_USER_MAP, AD9388_USER_PRIM_MODE, 0x06);
    	/*VID_STD=00111b for automatic graphics mode VID_STD_RESERVED*/
	I2C_Write(byChannel, I2C_ADDR_USER_MAP, AD9388_USER_VID_STD, 0x07);

        /*Setting cp_op_sel = 2 & Enable DE VS HS*/
	I2C_Write(byChannel, I2C_ADDR_USER_MAP, AD9388_USER_CP_OUT_SEL, 0xe2);
    	/*color too white rgb 656 range*/
	I2C_Write(byChannel, I2C_ADDR_USER_MAP, AD9388_USER_CSC_22, 0x01);

    dev_ARGB_SetSavEav(byChannel,0,0,0,0);

        /*Sed DE start H Start to prevent to masked data*/

    I2C_Write(byChannel, I2C_ADDR_USER_MAP, AD9388_USER_CP_DE_CTRL_1, 0x40);

    I2C_Write(byChannel, I2C_ADDR_USER_MAP, AD9388_USER_CP_DE_CTRL_3, 0x00);
        //以下为非正常情况下使用
}
...
void DriverChip9388A::dev_ARGB_GeneralConfig(uint32_t byChannel)
{
    ...
    I2C_Write(byChannel, I2C_ADDR_USER_MAP, AD9388_USER_PRIM_MODE, 0x02);

    	/*VID_STD=00111b for automatic graphics mode*/
    I2C_Write(byChannel, I2C_ADDR_USER_MAP, AD9388_USER_VID_STD, 0x07);

    	/*SOG Sync level for atenuated sync, PLL Qpump = 6h*/
    I2C_Write(byChannel, I2C_ADDR_USER_MAP, AD9388_USER_TLLC_CTRL, 0xae);

        /*Enable Automatic VCO Range. Enable auto PLL-Qpump for this mode.*/
    I2C_Write(byChannel, I2C_ADDR_USER_MAP, AD9388_USER_PLL_QPUMP_CTRL, 0x0a);
...
void DriverChip9388A::dev_ARGB_PLLVocManEn(uint32_t byChannel,uint8_t byFlg)
{
    ...
    I2C_Read(byChannel, I2C_ADDR_USER_MAP, AD9388_USER_CP_TLLC_CTRL_1,byValue);
    ...
    I2C_Write(byChannel,I2C_ADDR_USER_MAP,AD9388_USER_CP_TLLC_CTRL_1,byValue);



    I2C_Read(byChannel, I2C_ADDR_USER_MAP, AD9388_USER_CP_TLLC_CTRL_4,byValue);
    ...
    I2C_Write(byChannel,I2C_ADDR_USER_MAP,AD9388_USER_CP_TLLC_CTRL_4,byValue);
...
void DriverChip9388A::dev_ARGB_SetPllDivRatio(uint32_t byChannel,uint16_t wPllDivRatio)
{
    ...
    I2C_Write(byChannel,I2C_ADDR_USER_MAP,AD9388_USER_CP_TLLC_CTRL_2,byLByte);
...
void DriverChip9388A::dev_ARGB_SetFRLL(uint32_t byChannel,uint16_t wBL)
{
    ...
    I2C_Read(byChannel, I2C_ADDR_USER_MAP, AD9388_USER_FR_LL_1,byValue);
    byValue  = byValue & 0xf8;
    byValue  = byValue | byHByte;
    I2C_Write(byChannel,I2C_ADDR_USER_MAP,AD9388_USER_FR_LL_1,byValue);

    I2C_Write(byChannel,I2C_ADDR_USER_MAP,AD9388_USER_FR_LL_2,byLByte);
...
void DriverChip9388A::dev_ARGB_SetFRLCountMax(uint32_t byChannel,uint16_t wLCountMax)
{
    ...
    I2C_Write(byChannel,I2C_ADDR_USER_MAP,AD9388_USER_DPP_CP_90,byHByte);
    I2C_Write(byChannel,I2C_ADDR_USER_MAP,AD9388_USER_DPP_CP_91,byLByte);
...
void DriverChip9388A::dev_ARGB_SetSavEav(uint32_t byChannel,uint16_t  wCPSAV,uint16_t  wCPEAV,uint16_t  wVBISAV,uint16_t wVBIEAV)
{
    ...
    I2C_Write(byChannel,I2C_ADDR_USER_MAP,AD9388_USER_RB_CP_START_SAV,byValue);

    byValue = (uint8_t)( ((wCPSAV << 4) & 0x00f0) | ((wCPEAV >> 8) & 0x000f) );
    I2C_Write(byChannel,I2C_ADDR_USER_MAP,AD9388_USER_RB_CP_START_SAV_EAV,byValue);

    byValue = (uint8_t)(wCPEAV & 0x00ff);
    I2C_Write(byChannel,I2C_ADDR_USER_MAP,AD9388_USER_RB_CP_START_EAV,byValue);

    byValue =  (uint8_t)((wVBISAV >> 4) & 0x00ff);
    I2C_Write(byChannel,I2C_ADDR_USER_MAP,AD9388_USER_RB_CP_START_VBI,byValue);

    byValue = (uint8_t)( ((wVBISAV << 4) & 0x00f0) | ((wVBIEAV >> 8) & 0x000f) );
    I2C_Write(byChannel,I2C_ADDR_USER_MAP,AD9388_USER_RB_CP_START_END_VBI,byValue);

    byValue = (uint8_t)(wVBIEAV & 0x00ff);
    I2C_Write(byChannel,I2C_ADDR_USER_MAP,AD9388_USER_RB_CP_END_VBI,byValue);
...
void DriverChip9388A::getLineWidth(uint32_t byChannel,uint16_t &wLineWidth)
{
	...
	I2C_Read(byChannel,I2C_ADDR_HDMI_MAP,AD9388_HDMI_REG_07,byValue);

	wLineWidth = byValue & 0x0f;
	wLineWidth = wLineWidth << 8;

	I2C_Read(byChannel,I2C_ADDR_HDMI_MAP,AD9388_HDMI_LINE_WIDTH,byValue);
...
void DriverChip9388A::getTMDSFreq(uint32_t byChannel,uint8_t &byTMDSFreq)
{
	...
	I2C_Read(byChannel,I2C_ADDR_HDMI_MAP,AD9388_HDMI_TMDSFREQ,byValue);
...
void DriverChip9388A::getF0H(uint32_t byChannel,uint16_t &wF0H)
{
	...
	I2C_Read(byChannel,I2C_ADDR_HDMI_MAP,AD9388_HDMI_FLD_0_HT_H,byValue);

	wF0H = byValue & 0x0f;
	wF0H = wF0H << 8;

	I2C_Read(byChannel,I2C_ADDR_HDMI_MAP,AD9388_HDMI_FLD_0_HT_L,byValue);
...
void DriverChip9388A::getF1H(uint32_t byChannel,uint16_t &wF1H)
{
    ...
    I2C_Read(byChannel,I2C_ADDR_HDMI_MAP,AD9388_HDMI_REG_0B,byValue);

    wF1H = byValue & 0x0f;
    wF1H = wF1H << 8;

    I2C_Read(byChannel,I2C_ADDR_HDMI_MAP,AD9388_HDMI_FLD_1_HT,byValue);
...
void DriverChip9388A::dev_DRGB_DetectInput(uint32_t byChannel, uint8_t &bySignalState)
{
    uint8_t byValue1 = 0;
    uint8_t byValue2 = 0;
    I2C_Read(byChannel,I2C_ADDR_HDMI_MAP,AD9388_HDMI_REG_04,byValue1);
    I2C_Read(byChannel,I2C_ADDR_HDMI_MAP,AD9388_HDMI_REG_07,byValue2);
...
void DriverChip9388A::dev_ARGB_SetPhase(uint32_t byChannel,uint8_t byPhase)
{
    ...
    I2C_Read(byChannel, I2C_ADDR_USER_MAP,AD9388_USER_TLLC_PHS_ADJ,byValue);

    byValue = (byValue & 0xe0) | (byPhase & 0x1f);

    I2C_Write(byChannel, I2C_ADDR_USER_MAP,AD9388_USER_TLLC_PHS_ADJ, byValue);
...
{
	I2C_Read(byChannels,I2C_ADDR_USER_SUB_MAP_1,AD9388_SUB1_CP_BRIGHTNESS,byBrightness);

}

void DriverChip9388A::dev_RGB_SetBrightness(uint32_t byChannels,uint8_t byBrightness)
{
	I2C_Write(byChannels,I2C_ADDR_USER_SUB_MAP_1,AD9388_SUB1_CP_BRIGHTNESS,byBrightness);

}

void DriverChip9388A::dev_RGB_GetContrast(uint32_t byChannels,uint8_t &byContrast)
{
	I2C_Read(byChannels,I2C_ADDR_USER_SUB_MAP_1,AD9388_SUB1_CP_CONTRAST,byContrast);
}
void DriverChip9388A::dev_RGB_SetContrast(uint32_t byChannels,uint8_t byContrast)
{
	I2C_Write(byChannels,I2C_ADDR_USER_SUB_MAP_1,AD9388_SUB1_CP_CONTRAST,byContrast);
...
{
	I2C_Read(byChannels,I2C_ADDR_USER_SUB_MAP_1,AD9388_SUB1_CP_SATURATION,bySaturation);
...
void DriverChip9388A::dev_RGB_SetSaturation(uint32_t byChannels,uint8_t bySaturation)
{
	...
	I2C_Write(byChannels,I2C_ADDR_USER_SUB_MAP_1,AD9388_SUB1_CP_SATURATION,bySaturation);
...
void DriverChip9388A::dev_RGB_GetColorPhase(uint32_t byChannels,uint8_t &byColorPhase)
{
	...
	I2C_Read(byChannels,I2C_ADDR_USER_SUB_MAP_1,AD9388_SUB1_CP_HUE,byColorPhase);

}

void DriverChip9388A::dev_RGB_SetColorPhase(uint32_t byChannels,uint8_t byColorPhase)
{
	I2C_Write(byChannels,I2C_ADDR_USER_SUB_MAP_1,AD9388_SUB1_CP_HUE,byColorPhase);
