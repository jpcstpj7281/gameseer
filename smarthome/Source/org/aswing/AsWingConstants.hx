...
class AsWingConstants{
	...
	inline public static var MAX_VALUE:Int= #if neko 0x20000000 #else 0x40000000 #end;

	//inline public static var MIN_VALUE:Int=  -2147483648;
	inline public static var MIN_VALUE:Int=  #if neko -0x20000000 #else -0x40000000 #end;
