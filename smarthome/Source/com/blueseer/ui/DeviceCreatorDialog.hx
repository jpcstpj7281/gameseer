...
class DeviceCreatorDialog extends CommDialog{
    ...
    public function onOK(evt:MouseEvent){
        ...
        var deviceName:String = _usrInput.text;
    ...
    public function createDevice( name:String):Void{
        DeviceMgr.getInst().createDevice( name);
    }
